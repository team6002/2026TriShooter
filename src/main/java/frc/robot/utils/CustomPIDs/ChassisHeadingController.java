...
public class ChassisHeadingController {
     ...
     *
     * <p>This request will cause {@link #calculate(ChassisSpeeds, Pose2d)} to return zero
     * correction speeds.
     */
     ...
     *
     * @param chassisRotationConstraints defines the maximum angular velocity and acceleration for
     *     the drivetrain
     ...
     * @return (optionally) the calculated correction speed for rotation control, if the request
     *     type is not null
     */
     ...
     *
     * <p>For a continuously changing target, feed-forward velocity is added to help the chassis
     * stay aligned. This feed-forward is based on the target's angular velocity relative to the
     * robot, improving tracking accuracy.
     *
     * @param measuredSpeedsFieldRelative the measured chassis speeds, field-relative
     * @param robotPose the current pose of the robot as measured by odometry
     ...
     * @return a {@link edu.wpi.first.math.trajectory.TrapezoidProfile.State} representing the
     *     target goal state
     */
