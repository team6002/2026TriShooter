...
public class MapleJoystickDriveInput {
    ...
    /**
     * apply a smart dead-band to the given axis value unlike normal dead-banding, the threshold of
     * a smart deadband increases as the value of the other axis increases this will make it easier
     * for the pilot to set request a straight-line driving
     *
