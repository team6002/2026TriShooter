...
public class AlertsManager {
   ...
   * not persistent, they are gone after the robot is enabled. This command ends automatically if an
   * Error is present, so that the LED would instead be linking Red.
   */
