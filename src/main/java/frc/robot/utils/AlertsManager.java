...
public class AlertsManager {
    ...
    /**
     * Creates the command the flashes the LED Red to show that there is an error. Errors are
     * persistent, the LED will not stop flashing until all errors are gone.
     */
    ...
    /**
     * Creates the command the flashes the LED Orange to show that there is a warning. Warnings are
     * not persistent, they are gone after the robot is enabled. This command ends automatically if
     * an Error is present, so that the LED would instead be linking Red.
     */
