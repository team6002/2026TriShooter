...
public class DriveConstants {
    ...
    public static final double driveKa = 0.01421;
    ...
    public static final Force MAX_PROPELLING_FORCE =
            NewtonMeters.of(
                            DRIVE_MOTOR_MODEL.getTorque(
                                            DRIVE_ANTI_SLIP_TORQUE_CURRENT_LIMIT.in(Amps))
                                    * DRIVE_GEAR_RATIO)
                    .div(WHEEL_RADIUS)
                    .times(4);
    ...
    public static final AngularVelocity CHASSIS_MAX_ANGULAR_VELOCITY =
            RadiansPerSecond.of(
                    CHASSIS_MAX_VELOCITY.in(MetersPerSecond) / DRIVE_BASE_RADIUS.in(Meters));
    public static final AngularAcceleration CHASSIS_MAX_ANGULAR_ACCELERATION =
            RadiansPerSecondPerSecond.of(
                    CHASSIS_MAX_ACCELERATION.in(MetersPerSecondPerSecond)
