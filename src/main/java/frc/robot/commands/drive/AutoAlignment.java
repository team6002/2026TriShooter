...
public class AutoAlignment {
  ...
  public static Command pathFindAndAutoAlignStatic(
    ...
    Command pathFindToRoughTarget =
        pathFindToPose(target.roughTarget(), target.faceToTargetDuringRoughApproach(), config)
            .onlyIf(
                () ->
  ...
  public static Command pathFindToPose(
    ...
    Command activateChassisHeadingController =
        Commands.runOnce(
            () -> ChassisHeadingController.getInstance().setHeadingRequest(chassisHeadingRequest));
        ...
        .until(
            () ->
                RobotState.getInstance()
                    ...
                    < config.distanceStartPreciseApproach.in(Meters))
        .deadlineFor(
            RobotState.getInstance().withNavigationMode(RobotState.NavigationMode.VISION_GUIDED))
