...
public class RobotState {
  ...
  public void resetPose(Pose2d pose) {
    ...
    // new
    // frame of rotation
    gyroOffset = pose.getRotation().minus(odometryPoseSensorLess.getRotation().minus(gyroOffset));
  ...
  public Pose2d getPoseWithLookAhead() {
    ...
    double translationalLookaheadTimeSeconds =
        switch (navigationMode) {
          ...
          case VISION_FUSED_ODOMETRY, VISION_GUIDED ->
              TRANSLATIONAL_LOOKAHEAD_TIME_VISION.in(Seconds);
        };
